...
# === Step 4: Apply CAR-T Infusion ===
def apply_cart_infusion(tensor, target_threshold=0.6, kill_factor=0.4):
    cart_mask = tensor > target_threshold
    tensor[cart_mask] *= (1 - kill_factor)
    return tensor
...
tensor = apply_cart_infusion(tensor, target_threshold=0.6, kill_factor=0.4)
tensor = collapse_tensor_multifreq(tensor)

# === Output ===
print("CAR-T infusion applied.")
